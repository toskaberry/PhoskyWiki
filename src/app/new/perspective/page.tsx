  ...
  if (!sessionUser) {
    return (
      <PageContainer className="max-w-3xl">
        <TaskPageHeader
          breadcrumb={[{ label: "首页", href: "/" }, { label: "新建视角" }]}
          kicker="编者任务 · 创建"
          title="需要登录才能撰写视角"
  ...
  return (
    <PageContainer className="max-w-3xl">
      <TaskPageHeader
        ...
        description={
          <>
            <p>视角 =「诠释者 × 词条」的一次完整诠释；同一诠释者对同一词条只能有一个视角。</p>
            <p>
      ...
      <div className="mt-8">
        <SubmissionForm
          ...
          interpreters={interpreters.map((interpreter) => ({ id: interpreter.pageId, label: interpreter.name }))}
